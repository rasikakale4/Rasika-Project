...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String COL2 = "state_name";
    private static final String COL3 = "District_name";
    ...
    public boolean addData1(String item, String item1) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
...
//    }
//
//    public boolean addData1(int id, String DistrictName)
//    {
//
//        SQLiteDatabase db = this.getWritableDatabase();
//                String query = "UPDATE " + TABLE_NAME + " SET " + COL5 +
//                " = '" + DistrictName + "' WHERE " + COL1 + " = '"+ id +"'" +
//                " AND " + COL3 + " = '" + phone + "'";
//        Log.d(TAG, "updateName: query: " + query);
//        Log.d(TAG, "updateName: Setting name to " + DistrictName);
//        db.execSQL(query);
//        return true;
//    }
}